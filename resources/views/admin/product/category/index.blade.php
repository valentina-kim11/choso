...
@section('content')
    <div class="tp_main_content_wrappo">
        <div class="tp_tab_wrappo">
            <ul>
                <li><a href="{{ route('admin.pro_category.create') }}">Thêm danh mục</a></li>
                <li class="active"><a href="{{ route('admin.pro_category.index') }}">Quản lý danh mục</a></li>
            </ul>
        </div>
                                    ...
                                    @if ($data->count() > 0)
                                        @foreach ($data as $key => $item)
                                            <tr id="table_row_{{ $item->id }}">
                                                ...
                                                <td>{{ $item->is_featured == 1 ? 'Có' : 'Không' }} </td>
                                                <td>
                                                    <ul>
