    ...
    <div class="tp_main_content_wrappo">
        <div class="tp_dashboared_content">
            <div class="tp_shortinfo">
                <h4 class="tp_heading mb-2">Chào mừng {{ auth()->user()->full_name }}</h4>
                <ul>
                    <li>
                        <div class="tp_infobox progres">
                            <div class="tp_infobox_img">
                                <img src="{{ $ASSET_URL }}images/total-user.svg" alt="total-user">
                            </div>
                    ...
                    <li>
                        <div class="tp_infobox fine">
                            <div class="tp_infobox_img">
                                <img src="{{ $ASSET_URL }}images/active-user.svg" alt="active-user">
                            </div>
                            <div class="tp_infobox_content">
                                <p>Tổng số Seller</p>
                                <h3>{{ $total_vendor }}</h3>
                    ...
                    <li>
                        <div class="tp_infobox danger">
                            <div class="tp_infobox_img">
                                <img src="{{ $ASSET_URL }}images/inactive-user.svg" alt="inactive-user">
                            </div>
                            <div class="tp_infobox_content">
            ...
            <div class="tp_filter_result mb-30 mt-30">
                <h4 class="tp_heading mb-20">Lọc kết quả theo các tùy chọn sau.</h4>
            ...
            <div class="tp_shortinfo">
                <ul>
                    <li>
                        <div class="tp_infobox progres">
                            <div class="tp_infobox_img">
                                <img src="{{ $ASSET_URL }}images/ragister-user.svg" alt="ragister">
                            </div>
                            <div class="tp_infobox_content">
                                <p>Đăng ký mới</p>
                                <h3 class="tp_violet_color">{{ $total_user_search }}</h3>
                            </div>
                        </div>
                    </li>
                    <li>
                    ...
                    <li>
                        <div class="tp_infobox success">
                            <div class="tp_infobox_img">
                                <img src="{{ $ASSET_URL }}images/amount.svg" alt="amount">
                            </div>
                            <div class="tp_infobox_content">
                                <p>Tổng doanh thu</p>
                    ...
                    <li>
                        <div class="tp_infobox success">
                            <div class="tp_infobox_img">
                                <img src="{{ $ASSET_URL }}images/total-revenue.svg" alt="amount">
                            </div>
                            <div class="tp_infobox_content">
                                <p>Doanh thu của Admin</p>
                                <h3 class="tp_orangedark_color">{{ number_format($total_admin_revenue, 0, ',', '.') }} Scoin</h3>
                            </div>
                        </div>
                    </li>
                </ul>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                        <div class="tp_chart_box">
                            ...
                            {!! $userRegistrationViewChart->container() !!}
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                        <div class="tp_chart_box">
...
@section('scripts')
    ...
    {!! $userRegistrationViewChart->script() !!}
