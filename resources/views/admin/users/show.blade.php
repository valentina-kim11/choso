...
<div class="tp_main_content_wrappo">
    <div class="tp_tab_wrappo">
        <ul>
            ...
            <li class="active"><a href="{{route('admin.users.create')}}">Xem người dùng</a></li>
        </ul>
    </div>
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="tp_catset_box tp_catset_singleuser">
                    @if ($data->avatar)
                        <div class="mt-2">
                            <img class="rounded-pill" src="{{ @$data->avatar }}"
                    ...
                    <div role="tabpanel" class="tab-pane active" id="info">
                        <div class="th_content_section">
                            ...
                            <div class="th_product_detail">
                                ...
                                <div class="product_info status">{{ set_date_with_time(@$data->email_verified_at ?? '') }}</div>
                            </div>
                            <div class="th_product_detail">
