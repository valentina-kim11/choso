        ...
        <div class="tp_tab_wrappo">
            ...
            @if (isset($product->id) && !@empty($product->id))
                <div class="tp_form_wrapper ">
                    <ul>
                        <li><a href="{{ route('vendor.product.edit', ['id' => $product->id]) }}">Chỉnh sửa (Bước 1)</a></li>
                    ...
                    <div class="tp_catset_box_wrapper">
                        <div class="tp_catset_box">
                            <form action="{{ route('vendor.product.store.step2') }}" id="product-sec-step-form"
                                ...
                                <div class="tp_form_wrapper tp_proimg2_multi @if (empty($data->preview_imgs)) d-none @endif">
                                <div class="row">
                                    @if (!empty($data->preview_imgs))
                                        @php 
                                        $preview_imgs_arr = (object) unserialize(@$data->preview_imgs); 
                                        @endphp
                                    ...
                                    <div class="col-lg-6 col-md-6">
                                        <div class="dropzone  file-upload dz-clickable" id="previewDropzone"
                                            ...
                                            <div class="dz-default dz-message">
                                                ...
                                                <p class="info_text">Kéo thả file vào đây hoặc bấm để chọn file</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="tp_seo_head">
                                    <h5>Miễn phí cho tất cả mọi người</h5>
                                    <hr>
                                </div>
                                <div class="tp_form_wrapper">
                                            ...
                                            <div id="multi_price_card">
                                                <div class="checkbox">
                                                    <label class="mb-3"><input type="checkbox" value="1"
                                                        ...
                                                        <i class="input-helper"></i>Bật chế độ mua nhiều tuỳ chọn.
                                                        Cho phép thêm nhiều mức giá vào giỏ hàng cùng lúc</label>
                                                </div>
                                                <div class="card">
                                            ...
                                            <div id="multi_price_card" class="d-none">
                                                <div class="checkbox mb-3">
                                                    <label><input type="checkbox" value="1" class="form-control"
                                                            ...
                                                            class="input-helper"></i>Bật chế độ mua nhiều tuỳ chọn.
                                                        Cho phép thêm nhiều mức giá vào giỏ hàng cùng lúc</label>
                                                </div>
                                                <div class="card">
                                                    <div class="card-body" id="price-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="tp_form_wrapper">
                                            <label class="mb-2">Tuỳ chọn loại sản phẩm</label>
                                            <div class="tp_custom_select tp_product_offer">
                                ...
                                <div class="tp_form_wrapper">
                                    <div class="card" id="single-card">
                                            ...
                                            @if (isset($data->multi_file) && !empty($data->multi_file))
                                                ...
                                                @foreach ($fileArr as $key => $value)
                                                    ...
                                                    <div class="row pt-product-variant-list" id="file-fields">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="tp_Form_wrapper">
                                                                <label class="mb-2">Tên file</label>
                                                                <input type="text" class="form-control"
                                                        ...
                                                        <div class="col-md-8">
                                                            <div class="tp_form_wrapper">
                                                                <label class="mb-2">Đường dẫn file ngoài</label>
                                                                <input type="text" class="form-control"
                                                                    name="file_external_url[]"
                                                                    value="{{ @$value['file_external_url'] }}"
                                                                    placeholder="Dán đường dẫn file ngoài vào đây..">
                                                                <span class="tp_inputnote">Dán đường dẫn file ngoài vào đây.</span>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="tp_form_wrapper">
                                                                <label class="mb-2">Tải file lên
                                                                    <div class="tp_tooltip tp-tooltip_file"> <i
                                                                            class="fa fa-info-circle"
                                                                            aria-hidden="true"></i>
                                                                        <span class="tp_tooltiptext tp_inputnote">
                                                                            <p>Nếu không có đường dẫn file ngoài, hãy tải file lên.</p>
                                                                        </span>
                                                                    </div>
                                                                </label>
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="tp_form_wrapper  ">
                                                                <label class="mb-2">Gán mức giá</label>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="tp_form_wrapper">
                                                            ...
                                                            <input type="text" class="form-control" name="file_name[]"
                                                                value="" placeholder="Nhập tên file">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-8">
                                                        <div class="tp_form_wrapper">
                                                            <label class="mb-2">Đường dẫn file ngoài
                                                            </label>
                                                            <input type="text" class="form-control"
                                                        ...
                                                        <div id="file-body">
                                                            <div class="file-upload dz-clickable depones"
                                                                ...
                                                                <div class="dz-default dz-message">
                                                                    <i class="fa fa-cloud-upload" aria-hidden="true"
                                                                        style="font-size: 40px;margin-top: 10px"></i>
                                                                    <p class="info_text">Kéo thả file vào đây hoặc bấm để chọn file
                                                                    </p>
                                                                </div>
                                        ...
                                        <div class="card-footer">
                                            <button type="button" id="add_new_file" class="tp_btn float-end">Thêm file</button>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card d-none" id="bundle-card">
                                        ...
                                        <div class="card-footer">
                                            <button type="button" id="add_new_file2" class="tp_btn float-end">Thêm file</button>
                                        </div>
                                    </div>
                                    @if (isset($data) && !empty($data))
                                        <div class="tp_seo_head">
                                            <h5>Là bản cập nhật tiếp theo</h5>
                                        </div>
                                        <div class="tp_form_wrapper mt-2">
                                            <div class="checkbox">
                                                <label>
                                                    <input type="checkbox" value="1" class="form-control"
                                                        name="is_next_update"><i class="input-helper"></i>Có</label>
                                            </div>
                                        </div>
                                    @endif
                                </div>
