        ...
        <div class="tp_tab_wrappo">
            ...
            @if (isset($data->id) && !@empty($data->id))
                <div class="tp_form_wrapper ">
                    <ul>
                        <li class="active"><a href="{{ route('vendor.product.edit', ['id' => $data->id]) }}">Chỉnh sửa (Bước 1)</a>
                        </li>
                        <li><a href="{{ route('vendor.product.edit.step2', ['id' => $data->id]) }}">Chỉnh sửa (Bước 2)</a></li>
                    </ul>
                </div>
            @endif
        </div>
                    ...
                    <div class="tp_catset_box_wrapper">
                        <div class="tp_catset_box tp_pro_step1">
                            <div class="alert alert-info">
                                <strong>Thông báo!</strong> Vui lòng điền các thông tin bạn muốn, các trường có dấu (*) là bắt buộc. Các trường để trống sẽ không hiển thị cho người dùng.
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-12">
                                        <div class="tp_form_wrapper">
                                            ...
                                            <input type="text" class="form-control append-slug" name="slug"
                                                placeholder="Nhập đường dẫn (Slug)" value="{{ @$data->slug }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-12 col-md-12">
                                        <div class="tp_form_wrapper tp_form_textarea">
                                            ...
                                            <textarea rows="5" cols="50" spellcheck="true" class="form-textarea" placeholder="Nhập từ khóa, cách nhau bởi dấu phẩy (,)" name="tags"
                                                placeholder="Nhập từ khóa, cách nhau bởi dấu phẩy (,)">{{ @$data->tags }}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                    ...
                                    <div class="col-md-12">
                                       <div class="tp_seo_head">
                                        ...
                                        <div class="alert alert-info ">
                                            ...
                                            <p><b>Trình duyệt tương thích</b> : Firefox, Safari, Opera, Chrome, Edge, v.v.</p>
                                            <p><b>File bao gồm</b> HTML, CSS, PHP, SQL, v.v. </p>
                                    ...
                                    @if (isset($data->id) && !@empty($data->id))
                                        <button id="product-first-step-form-btn" type="submit" class="tp_btn">Cập nhật (Bước 1)</button>
                                    @else
                                        <button id="product-first-step-form-btn" type="submit" class="tp_btn">Thêm mới (Bước 1)</button>
                                    @endif
                            </form>
                        </div>
                    </div>
