...
<head>
    ...
    <style>
           :root {
            ...
            --tp-text-color: <?php echo @$setting->text_color ?? '#53627a' ?>;
            --tp-body-bg-color:<?php echo @$setting->body_color ?? '#eff5fc' ?>;
        }
    </style>
    <!-------- Style-sheet Start -------->
...
<body>
    ...
    <div class="tp_main_wrappo">
        ...
        <div class="tp_main_structure">
            @include('author.layouts.header',['setting' => $setting,'primary_color'=> @$setting->primary_color ?? '#00796B'])
            @yield('content')
        </div>
    </div>
    <!-- BEGIN JAVASCRIPT -->
