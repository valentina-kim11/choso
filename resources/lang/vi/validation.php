...
return [
    ...
    | lớp kiểm tra dữ liệu. Một số quy tắc có nhiều phiên bản như quy tắc size.
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Tại đây bạn có thể chỉ định thông báo kiểm tra dữ liệu tùy chỉnh cho từng thuộc tính.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Các dòng ngôn ngữ sau được sử dụng để thay thế cho các thuộc tính mặc định
    | bằng một cái tên thân thiện hơn như "Địa chỉ Email" thay vì "email".
    |
    */
