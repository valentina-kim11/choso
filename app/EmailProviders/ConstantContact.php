 ...
 */
	...
	class ConstantContact
	{
		 ...
		 */
		protected $api_key = '8fd233ae-ab6a-4895-9881-4c1f2efbdf2d';
		 ...
		 * @access 	public
		 */
		protected $api_url = 'https://api.constantcontact.com';
		 ...
		 * @access 	protected
		 */
		protected $action_type = 'ACTION_BY_CUSTOMER';
		 ...
		 * @access public
		 */
		public $http_request_timeout = 120;
		 ...
		 * @access protected
		 */
		public $http_default_content_type = 'text/html';
		 ...
		 * @access protected
		 */
		protected $http_request_headers = array();
		 ...
		 * @access protected
		 */
		protected $http_response_headers = array();
		 ...
		 * @access public
		 */
		protected $xml_known_encodings = array('UTF-8', 'US-ASCII', 'ISO-8859-1');
		...
		public function __construct($api_username, $api_password)
		{
			...
			$this->http_user = $this->api_key . "%" . $this->api_username;
	  ...
	  function xml_to_array($contents, $get_attributes=1, $priority = 'tag')
		{
			...
			list($parser, $source) = $this->xml_create_parser($contents, $output_encoding, $input_encoding, $detect_encoding);
